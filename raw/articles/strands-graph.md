...
A Graph is a deterministic directed graph based agent orchestration system where agents, custom nodes, or other multi-agent systems (like [Swarm](/docs/user-guide/concepts/multi-agent/swarm/) or nested Graphs) are nodes in a graph. Nodes are executed according to edge dependencies, with output from one node passed as input to connected nodes. The Graph pattern supports both acyclic (DAG) and cyclic topologies, enabling feedback loops and iterative refinement workflows.
...
[Section titled “How Graphs Work”](#how-graphs-work)
...
[Section titled “Graph Components”](#graph-components)
...
[Section titled “1. GraphNode”](#1-graphnode)
...
[Section titled “2. GraphEdge”](#2-graphedge)
...
[Section titled “3. GraphBuilder”](#3-graphbuilder)
...
[Section titled “Graph Constructor”](#graph-constructor)
...
[Section titled “Creating a Graph”](#creating-a-graph)
...
[Section titled “Conditional Edges”](#conditional-edges)
...
[Section titled “Waiting for All Dependencies”](#waiting-for-all-dependencies)
...
[Section titled “Nested Multi-Agent Patterns”](#nested-multi-agent-patterns)
...
[Section titled “Remote Agents with A2AAgent”](#remote-agents-with-a2aagent)

Graphs support remote A2A agents as nodes through the [`A2AAgent`](/docs/user-guide/concepts/multi-agent/agent-to-agent/#consuming-remote-agents) class. You can add it directly to a graph just like a local agent. This enables distributed architectures where orchestration happens locally while specialized tasks run on remote services.
...
[Section titled “Custom Node Types”](#custom-node-types)
...
[Section titled “Multi-Modal Input Support”](#multi-modal-input-support)

Graphs support multi-modal inputs like text and images:

- [Python](#tab-panel-1727)
...
[Section titled “Streaming Events”](#streaming-events)
...
See the [streaming overview](/docs/user-guide/concepts/streaming/#multi-agent-events) for details on all multi-agent event types.

## Graph Results

[Section titled “Graph Results”](#graph-results)

When a Graph completes execution, it returns a result object with detailed information:

- [Python](#tab-panel-1731)
- [TypeScript](#tab-panel-1732)
...
[Section titled “Input Propagation”](#input-propagation)
...
For detailed information about shared state, including examples and best practices, see [Shared State Across Multi-Agent Patterns](/docs/user-guide/concepts/multi-agent/multi-agent-patterns/#shared-state-across-multi-agent-patterns).

## Graphs as a Tool

[Section titled “Graphs as a Tool”](#graphs-as-a-tool)
...
[Section titled “Common Graph Topologies”](#common-graph-topologies)

### 1. Sequential Pipeline

[Section titled “1. Sequential Pipeline”](#1-sequential-pipeline)
...
[Section titled “2. Parallel Processing with Aggregation”](#2-parallel-processing-with-aggregation)
...
[Section titled “3. Branching Logic”](#3-branching-logic)
...
[Section titled “4. Feedback Loop”](#4-feedback-loop)
...
[Section titled “SDK Differences”](#sdk-differences)
