...
[Section titled “How the Loop Works”](#how-the-loop-works)
...
[Section titled “A Concrete Example”](#a-concrete-example)
...
[Section titled “Messages and Conversation History”](#messages-and-conversation-history)
...
[Section titled “Loop Lifecycle”](#loop-lifecycle)
...
[Section titled “Starting the Loop”](#starting-the-loop)
...
[Section titled “Stop Reasons”](#stop-reasons)
...
[Section titled “Extending the Loop”](#extending-the-loop)

The agent emits lifecycle events at key points: before and after each invocation, before and after each model call, and before and after each tool execution. These events enable observation, metrics collection, and behavior modification without changing the core loop logic. See [Hooks](/docs/user-guide/concepts/agents/hooks/) for details on subscribing to these events.

### Cancellation

[Section titled “Cancellation”](#cancellation)
...
- [Python](#tab-panel-1322)
- [TypeScript](#tab-panel-1323)
...
Cancellation differs from [interrupts](/docs/user-guide/concepts/interrupts/) in that it stops the agent entirely rather than pausing for human input. Interrupts allow the agent to resume from where it left off; cancellation does not.
...
[Section titled “External cancellation signals”](#external-cancellation-signals)
...
[Section titled “Cancellation within tool execution”](#cancellation-within-tool-execution)
...
[Section titled “Context Window Exhaustion”](#context-window-exhaustion)
...
[Section titled “What Comes Next”](#what-comes-next)

The agent loop is the execution primitive. Higher-level patterns build on top of it:

- [Conversation Management](/docs/user-guide/concepts/agents/conversation-management/) strategies that maintain coherent long-running interactions
- [Hooks](/docs/user-guide/concepts/agents/hooks/) for observing, modifying, and extending agent behavior
