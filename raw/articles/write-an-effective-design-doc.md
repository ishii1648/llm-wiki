...
by [Michael Lynch](/author), published
June 24, 2026
...
[
Your browser does not support the video tag.](little-moments-demo.mp4)
...
Now, realize that some readers will see the doc before hearing any explanation from you, so whatever they need to understand [should be on the first page of your doc](/excerpts/useful-feedback-on-design-docs/#write-an-introduction-that-makes-sense-to-everyone).
