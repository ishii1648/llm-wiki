...
[Section titled “Integration Approaches”](#integration-approaches)
...
[Section titled “Streamable HTTP”](#streamable-http)

For HTTP-based MCP servers that use Streamable HTTP transport:

- [Python](#tab-panel-1903)
...
[Section titled “AWS IAM”](#aws-iam)
...
[Section titled “Using Multiple MCP Servers”](#using-multiple-mcp-servers)
...
[Section titled “Implementing an MCP Server”](#implementing-an-mcp-server)
...
[Section titled “Elicitation”](#elicitation)
...
[Section titled “MCPClientInitializationError (Python)”](#mcpclientinitializationerror-python)
...
[Section titled “Connection Failures”](#connection-failures)
...
[Section titled “Tool Discovery Issues”](#tool-discovery-issues)
...
[Section titled “Tool Execution Errors”](#tool-execution-errors)
