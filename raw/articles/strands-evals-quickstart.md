...
[Section titled “What Strands Evaluation Provides”](#what-strands-evaluation-provides)
...
[Section titled “Basic Output Evaluation”](#basic-output-evaluation)
...
[Section titled “Tool Usage Evaluation”](#tool-usage-evaluation)
...
[Section titled “Trace-based Helpfulness Evaluation”](#trace-based-helpfulness-evaluation)
...
[Section titled “Running Evaluations”](#running-evaluations)
...
[Section titled “Async Evaluation”](#async-evaluation)
...
[Section titled “Basic Async Example (Applies to Trace-based evaluators)”](#basic-async-example-applies-to-trace-based-evaluators)
...
[Section titled “Understanding Evaluation Results”](#understanding-evaluation-results)
...
[Section titled “Automated Experiment Generation”](#automated-experiment-generation)
...
[Section titled “Evaluation Strategy”](#evaluation-strategy)
...
[Section titled “Experiment Management”](#experiment-management)
...
- [Task Decorator](/docs/user-guide/evals-sdk/how-to/eval_task/) - Simplify task functions with `@eval_task`
- [Output Evaluator](/docs/user-guide/evals-sdk/evaluators/output_evaluator/) - LLM-based output evaluation with custom rubrics
- [Trajectory Evaluator](/docs/user-guide/evals-sdk/evaluators/trajectory_evaluator/) - Tool usage and sequence evaluation
- [Helpfulness Evaluator](/docs/user-guide/evals-sdk/evaluators/helpfulness_evaluator/) - Seven-level helpfulness assessment
- [Correctness Evaluator](/docs/user-guide/evals-sdk/evaluators/correctness_evaluator/) - Factual correctness with optional reference comparison
- [Deterministic Evaluators](/docs/user-guide/evals-sdk/evaluators/deterministic_evaluators/) - Fast, code-based checks (Equals, Contains, ToolCalled)
- [Custom Evaluators](/docs/user-guide/evals-sdk/evaluators/custom_evaluator/) - Build domain-specific evaluation logic
- [Tool Simulation](/docs/user-guide/evals-sdk/simulators/tool_simulation/) - Test tool-using agents without real infrastructure
- [Result Caching](/docs/user-guide/evals-sdk/how-to/result_caching/) - Cache task results to iterate on evaluators without re-running agents
- [Remote Trace Providers](/docs/user-guide/evals-sdk/how-to/trace_providers/) - Evaluate traces from production backends
- [Experiment Generator](/docs/user-guide/evals-sdk/experiment_generator/) - Automatically generate comprehensive test suites
- [Serialization](/docs/user-guide/evals-sdk/how-to/serialization/) - Save, load, and version your evaluation experiments
- [Detectors](/docs/user-guide/evals-sdk/detectors/) - Automatic failure detection and root cause analysis for agent traces
