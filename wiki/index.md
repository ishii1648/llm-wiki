...
- [[addy-osmani]] — agentic development を論じるブロガー/エンジニア。[[loop-engineering]] の著者ハブ (updated: 2026-06-20)
- [[peter-steinberger]] — [[loop-engineering]] の発火点。「prompt するな、prompt するループを設計せよ」(X: @steipete) (updated: 2026-06-20)
- [[boris-cherny]] — Anthropic の Claude Code 責任者。「もう Claude に prompt しない。仕事はループを書くこと」 (updated: 2026-06-20)
